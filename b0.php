...
$address="esenaliev2304@gmail.com";
// текст письма 
$note_text="Тема : $urok \r\nИмя : $name1 \r\n Телефон : $email1 \r\n Сообщение : $text";
...
echo "<p style='color:green;'>Уважаемый(ая) <b style='color:red;'>$name1</b> Ваше письмо отправленно успешно. <br> Спасибо. <br>Вам скоро позвонят на этот номер: <b style='color:red;'> $email1</b>.</p>";
}
